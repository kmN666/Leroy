...
#define GOSSIP_TRALLMAR			"Send me to Thrallmar!"
#define GOSSIP_HH				"Send me to Honor Hold!"
...
public:
    ...
    bool OnGossipHello(Player* player, Creature* creature)
    {
        ...
        case 17435: // Azuremyst Isle - Susurrus
            ...
            break;
		case 18930: // Hellfire Peninsula - Vlagga Freyfeather
            if (player->GetQuestStatus(10289)== QUEST_STATUS_INCOMPLETE)
                player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_TRALLMAR, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF+31);
            break;
		case 18931: // Hellfire Peninsula - Amish Wildhammer
            if (player->GetQuestStatus(10140)== QUEST_STATUS_INCOMPLETE)
                player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_HH, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF+32);
            break;
    ...
    bool OnGossipSelect(Player* player, Creature* creature, uint32 /*sender*/, uint32 action)
    {
		...
		case GOSSIP_ACTION_INFO_DEF + 31:
            player->CLOSE_GOSSIP_MENU();
            player->ActivateTaxiPathTo(565);
            break;
		case GOSSIP_ACTION_INFO_DEF + 32:
            player->CLOSE_GOSSIP_MENU();
            player->ActivateTaxiPathTo(564);
            break;
        }
