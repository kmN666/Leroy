...
## go_icc_blood_orb
######*/
class go_icc_blood_orb : public GameObjectScript
{
public:
    go_icc_blood_orb() : GameObjectScript("go_icc_blood_orb") { }

    bool OnGossipHello(Player* player, GameObject* go)
    {
		player->CastSpell(player,70227);
        return true;
    }
};

/*######
## go_icc_putricide_table
######*/
class go_icc_putricide_table : public GameObjectScript
{
public:
    go_icc_putricide_table() : GameObjectScript("go_icc_putricide_table") { }
...
#define GOSSIP_IC_TXT "Disturb the stone and summon Lord Ahune"
#define LORD_AHUNE 25740
...
public:
    ...
    bool OnGossipHello(Player* player, GameObject* go)
    {
        ...
        player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, GOSSIP_IC_TXT, GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF);
    ...
    bool OnGossipSelect(Player* player, GameObject* go, uint32 /*sender*/, uint32 action)
    {
        ...
        {
            case GOSSIP_ACTION_INFO_DEF:
            player->SummonCreature(LORD_AHUNE, -51.800f, -208.39f, 1.8364f, 0, TEMPSUMMON_CORPSE_DESPAWN, 1000);
            break;
        }
        return true;
    }
...
enum ePathToTheCitadelKillcredits
{
    KILLCREDIT_HORDE = 36770,
	KILLCREDIT_ALLY  = 36764,
};
...
public:
    ...
    bool OnGossipHello(Player* player, GameObject* go)
    {
		...
		{
		   player->KilledMonsterCredit(KILLCREDIT_HORDE, 0);
		}
		else
		{
		   player->KilledMonsterCredit(KILLCREDIT_ALLY,0);
		}
        player->CLOSE_GOSSIP_MENU();
        return true;
	}
