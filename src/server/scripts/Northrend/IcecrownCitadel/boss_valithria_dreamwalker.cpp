            ...
            void SpellHit(Unit* /*caster*/, SpellInfo const* spell)
            {
                if (spell->Id == SPELL_DREAM_SLIP)
                {
                    ...
                    if (GetDifficulty() == RAID_DIFFICULTY_10MAN_NORMAL)
                            me->SummonGameObject(GO_CACHE_OF_THE_DREAMWALKER_10N, 4203.91f, 2456.83f, 365.655f, 1.54f, 0, 0, 0, 0, 8640000000);
                        else if (GetDifficulty() == RAID_DIFFICULTY_10MAN_HEROIC)
                            me->SummonGameObject(GO_CACHE_OF_THE_DREAMWALKER_10H, 4203.91f, 2456.83f, 365.655f, 1.54f, 0, 0, 0, 0, 8640000000);
                        else if (GetDifficulty() == RAID_DIFFICULTY_25MAN_NORMAL)
                            me->SummonGameObject(GO_CACHE_OF_THE_DREAMWALKER_25N, 4203.91f, 2456.83f, 365.655f, 1.54f, 0, 0, 0, 0, 8640000000);
                        else
                            me->SummonGameObject(GO_CACHE_OF_THE_DREAMWALKER_25H, 4203.91f, 2456.83f, 365.655f, 1.54f, 0, 0, 0, 0, 8640000000); 
