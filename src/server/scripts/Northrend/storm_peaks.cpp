...
#define TEXT_MECHAGNOME "I'm not a laborer. I'm here to free you from servitude in the mines"
...
public:
	...
	bool OnGossipHello(Player* player, Creature* creature)
	{
		player->ADD_GOSSIP_ITEM(0, TEXT_MECHAGNOME, GOSSIP_SENDER_MAIN, 50);
	...
	bool OnGossipSelect(Player* player, Creature *creature, uint32 sender, uint32 action)
	{
		...
		{
		   case 50:
			   player->CastSpell(player, 55875, true);
			   player->KilledMonsterCredit(29384, 0);
