...
// http://ru.wowhead.com/quest=24749 - Сила нечестивости
class spell_q24749_unholy_infusion : public SpellScriptLoader
{
    public:
        spell_q24749_unholy_infusion() : SpellScriptLoader("spell_q24749_unholy_infusion") { }

        class spell_q24749_unholy_infusion_SpellScript : public SpellScript
        {
            PrepareSpellScript(spell_q24749_unholy_infusion_SpellScript);
            ...
            {
                Player* caster = GetCaster()->ToPlayer();
                caster->CompleteQuest(24749);
    }

            void Register()
            {
                OnEffectHitTarget += SpellEffectFn(spell_q24749_unholy_infusion_SpellScript::HandleDummy, EFFECT_0, SPELL_EFFECT_DUMMY);
            }
        };

        SpellScript* GetSpellScript() const
        {
            return new spell_q24749_unholy_infusion_SpellScript();
        }
};
...
void AddSC_quest_spell_scripts()
{
	...
	new spell_q24749_unholy_infusion();
}
